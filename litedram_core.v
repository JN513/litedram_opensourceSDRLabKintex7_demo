...
reg     [4:0] main_k7ddrphy_half_sys8x_taps_storage = 5'd4;
...
reg           main_k7ddrphy_rddata_en_tappeddelayline8 = 1'd0;
...
reg     [1:0] main_k7ddrphy_rdphase_storage = 2'd0;
...
reg     [1:0] main_k7ddrphy_wrphase_storage = -2'd1;
...
reg     [3:0] main_litedramcore_bankmachine0_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine1_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine2_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine3_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine4_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine5_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine6_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
reg     [3:0] main_litedramcore_bankmachine7_trccon_count = 4'd0;
(* dont_touch = "true" *)
...
wire   [27:0] main_litedramcore_zqcs_timer_count0;
reg    [27:0] main_litedramcore_zqcs_timer_count1 = 28'd199999999;
...
reg           main_user_port_cmd_valid = 1'd0;
...
reg           main_user_port_wdata_valid = 1'd0;
...
reg   [255:0] main_wb_port_dat_r = 256'd0;
wire  [255:0] main_wb_port_dat_w;
reg           main_wb_port_err = 1'd0;
wire   [31:0] main_wb_port_sel;
...
assign main_k7ddrphy_dfi_p0_rddata_valid = (main_k7ddrphy_rddata_en_tappeddelayline8 | main_k7ddrphy_wlevel_en_storage);
assign main_k7ddrphy_dfi_p1_rddata_valid = (main_k7ddrphy_rddata_en_tappeddelayline8 | main_k7ddrphy_wlevel_en_storage);
assign main_k7ddrphy_dfi_p2_rddata_valid = (main_k7ddrphy_rddata_en_tappeddelayline8 | main_k7ddrphy_wlevel_en_storage);
assign main_k7ddrphy_dfi_p3_rddata_valid = (main_k7ddrphy_rddata_en_tappeddelayline8 | main_k7ddrphy_wlevel_en_storage);
...
always @(*) begin
    ...
    case (builder_bankmachine0_state)
        ...
        4'd8: begin
            builder_bankmachine0_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine0_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine0_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine1_state)
        ...
        4'd8: begin
            builder_bankmachine1_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine1_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine1_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine2_state)
        ...
        4'd8: begin
            builder_bankmachine2_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine2_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine2_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine3_state)
        ...
        4'd8: begin
            builder_bankmachine3_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine3_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine3_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine4_state)
        ...
        4'd8: begin
            builder_bankmachine4_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine4_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine4_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine5_state)
        ...
        4'd8: begin
            builder_bankmachine5_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine5_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine5_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine6_state)
        ...
        4'd8: begin
            builder_bankmachine6_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine6_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine6_next_state <= 1'd0;
        end
...
always @(*) begin
    ...
    case (builder_bankmachine7_state)
        ...
        4'd8: begin
            builder_bankmachine7_next_state <= 4'd9;
        end
        4'd9: begin
            builder_bankmachine7_next_state <= 4'd10;
        end
        4'd10: begin
            builder_bankmachine7_next_state <= 1'd0;
        end
...
assign main_user_port_rdata_valid = builder_new_master_rdata_valid9;
always @(*) begin
...
always @(*) begin
    main_user_port_wdata_valid <= 1'd0;
    main_user_port_wdata_valid <= (main_wb_port_stb & main_wb_port_we);
    if (1'd1) begin
...
assign main_user_port_rdata_ready = 1'd1;
always @(*) begin
    ...
    case (builder_litedramwishbone2native_state)
        ...
        2'd2: begin
            if (main_user_port_rdata_valid) begin
                builder_litedramwishbone2native_next_state <= 1'd0;
            end
        end
        default: begin
            if (((main_user_port_cmd_valid & main_user_port_cmd_ready) & main_wb_port_we)) begin
...
always @(*) begin
    ...
    case (builder_litedramwishbone2native_state)
        ...
        default: begin
            main_user_port_cmd_valid <= (main_wb_port_cyc & main_wb_port_stb);
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    main_wb_port_dat_r <= 256'd0;
    case (builder_litedramwishbone2native_state)
        1'd1: begin
        end
        2'd2: begin
            if (main_user_port_rdata_valid) begin
                main_wb_port_dat_r <= main_user_port_rdata_payload_data;
            end
        end
        default: begin
        end
...
always @(posedge sys_clk) begin
    ...
    main_k7ddrphy_rddata_en_tappeddelayline8 <= main_k7ddrphy_rddata_en_tappeddelayline7;
    ...
    if ((main_litedramcore_timer_wait & (~main_litedramcore_timer_done0))) begin
        ...
        main_litedramcore_timer_count1 <= 11'd1562;
    end
    ...
    if ((main_litedramcore_sequencer_trigger == 3'd4)) begin
        main_litedramcore_cmd_payload_a <= 11'd1024;
        main_litedramcore_cmd_payload_ba <= 1'd0;
    ...
    if ((main_litedramcore_sequencer_trigger == 6'd56)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if ((main_litedramcore_zqcs_timer_wait & (~main_litedramcore_zqcs_timer_done0))) begin
        ...
        main_litedramcore_zqcs_timer_count1 <= 28'd199999999;
    end
    ...
    if ((main_litedramcore_zqcs_executer_trigger == 3'd4)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if ((main_litedramcore_zqcs_executer_trigger == 5'd21)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if (main_litedramcore_bankmachine0_twtpcon_valid) begin
        main_litedramcore_bankmachine0_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine0_trccon_valid) begin
        main_litedramcore_bankmachine0_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine0_trascon_valid) begin
        main_litedramcore_bankmachine0_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine1_twtpcon_valid) begin
        main_litedramcore_bankmachine1_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine1_trccon_valid) begin
        main_litedramcore_bankmachine1_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine1_trascon_valid) begin
        main_litedramcore_bankmachine1_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine2_twtpcon_valid) begin
        main_litedramcore_bankmachine2_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine2_trccon_valid) begin
        main_litedramcore_bankmachine2_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine2_trascon_valid) begin
        main_litedramcore_bankmachine2_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine3_twtpcon_valid) begin
        main_litedramcore_bankmachine3_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine3_trccon_valid) begin
        main_litedramcore_bankmachine3_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine3_trascon_valid) begin
        main_litedramcore_bankmachine3_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine4_twtpcon_valid) begin
        main_litedramcore_bankmachine4_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine4_trccon_valid) begin
        main_litedramcore_bankmachine4_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine4_trascon_valid) begin
        main_litedramcore_bankmachine4_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine5_twtpcon_valid) begin
        main_litedramcore_bankmachine5_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine5_trccon_valid) begin
        main_litedramcore_bankmachine5_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine5_trascon_valid) begin
        main_litedramcore_bankmachine5_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine6_twtpcon_valid) begin
        main_litedramcore_bankmachine6_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine6_trccon_valid) begin
        main_litedramcore_bankmachine6_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine6_trascon_valid) begin
        main_litedramcore_bankmachine6_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine7_twtpcon_valid) begin
        main_litedramcore_bankmachine7_twtpcon_count <= 3'd6;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine7_trccon_valid) begin
        main_litedramcore_bankmachine7_trccon_count <= 4'd10;
        if (1'd0) begin
    ...
    if (main_litedramcore_bankmachine7_trascon_valid) begin
        main_litedramcore_bankmachine7_trascon_count <= 3'd7;
        if (1'd0) begin
    ...
    if (main_litedramcore_trrdcon_valid) begin
        main_litedramcore_trrdcon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_litedramcore_twtrcon_valid) begin
        main_litedramcore_twtrcon_count <= 3'd5;
        if (1'd0) begin
    ...
    if (sys_rst) begin
        ...
        main_k7ddrphy_rddata_en_tappeddelayline8 <= 1'd0;
        ...
        main_litedramcore_bankmachine0_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine0_trccon_count <= 4'd0;
        main_litedramcore_bankmachine0_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine1_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine1_trccon_count <= 4'd0;
        main_litedramcore_bankmachine1_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine2_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine2_trccon_count <= 4'd0;
        main_litedramcore_bankmachine2_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine3_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine3_trccon_count <= 4'd0;
        main_litedramcore_bankmachine3_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine4_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine4_trccon_count <= 4'd0;
        main_litedramcore_bankmachine4_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine5_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine5_trccon_count <= 4'd0;
        main_litedramcore_bankmachine5_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine6_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine6_trccon_count <= 4'd0;
        main_litedramcore_bankmachine6_trascon_ready <= 1'd0;
        ...
        main_litedramcore_bankmachine7_trccon_ready <= 1'd0;
        main_litedramcore_bankmachine7_trccon_count <= 4'd0;
        main_litedramcore_bankmachine7_trascon_ready <= 1'd0;
        ...
        main_litedramcore_trrdcon_ready <= 1'd0;
        main_litedramcore_trrdcon_count <= 2'd0;
        main_litedramcore_tfawcon_ready <= 1'd1;
        main_litedramcore_tfawcon_window <= 9'd0;
        main_litedramcore_tccdcon_ready <= 1'd0;
        main_litedramcore_tccdcon_count <= 1'd0;
        main_litedramcore_twtrcon_ready <= 1'd0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-06-25 01:14:56.
//------------------------------------------------------------------------------
